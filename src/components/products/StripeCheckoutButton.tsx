...
export default function StripeCheckoutButton({
  ...
  const defaultClassName = "mt-2 px-4 py-2 border-2 rounded-md font-semibold transition-all duration-300 w-full";
  const activeClassName = "bg-primary text-white border-primary hover:bg-primary-dark hover:border-primary-dark";
