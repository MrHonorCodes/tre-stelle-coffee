		...
		<div className="bg-soft-white py-24">
			<div className="container mx-auto px-4 max-w-3xl">
				...
				<div className="prose prose-lg">
					...
					<p>
						At Tre Stelle Coffee Co. (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;), we
						...
						information when you visit our website, use our mobile application, visit our physical
						locations, or interact with us in any other way.
					</p>
					<p>
					...
					<h3 className="text-xl font-medium text-tertiary mt-6 mb-3">Personal Information</h3>
					...
					<h3 className="text-xl font-medium text-tertiary mt-6 mb-3">
						Automatically Collected Information
					</h3>
					<p>
						When you visit our website or use our mobile application, we may automatically collect
					...
					<ul className="list-disc pl-6 mb-4">
						...
						<li>
							Personalize your experience and deliver content and product offerings relevant to your
							interests
						</li>
					...
					<ul className="list-disc pl-6 mb-4">
						<li>
							Service providers who perform services on our behalf (payment processors, shipping
					...
					<p>
						...
						information against unauthorized access, accidental loss, destruction, or damage.
					...
					<p>
						Our services are not directed to individuals under the age of 13, and we do not
