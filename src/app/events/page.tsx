    ...
    <section className="py-16 bg-soft-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
            ...
            <div className="rounded-lg overflow-hidden shadow-md h-64">
                ...
                onError={(e) => {
                    ...
                    (e.target as HTMLImageElement).src = 'https://via.placeholder.com/800x600?text=Event+Space';
                }}
                />
            </div>
            </ScrollReveal>
            ...
            <div className="rounded-lg overflow-hidden shadow-md h-64">
                ...
                onError={(e) => {
                    (e.target as HTMLImageElement).onerror = null;
                    (e.target as HTMLImageElement).src = 'https://via.placeholder.com/800x600?text=Table+Setup';
                }}
                />
            </div>
            </ScrollReveal>
            ...
            <div className="rounded-lg overflow-hidden shadow-md h-64">
                ...
                onError={(e) => {
                    (e.target as HTMLImageElement).onerror = null;
                    (e.target as HTMLImageElement).src = 'https://via.placeholder.com/800x600?text=Coffee+Bar';
                }}
                />
            </div>
            </ScrollReveal>
        ...
        <ScrollReveal>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                <h4 className="text-lg font-semibold mb-4 border-b border-gray-200 pb-2">Event Details</h4>
                <ul className="space-y-3">
                    ...
                    <div>
                        <span className="font-medium">Pricing:</span> Event space rental begins at <span className="text-primary font-semibold">$100/hour</span>
                    </div>
                    </li>
                    <li className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-secondary mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                        <span className="font-medium">Service:</span> A barista will be present to monitor and will serve espresso-based drinks for sale
                    </div>
                    </li>
                </ul>
                </div>
                ...
                <div>
                    <h4 className="text-lg font-semibold mb-4 border-b border-gray-200 pb-2 text-green-600">Allowed</h4>
                ...
                <div>
                    <h4 className="text-lg font-semibold mb-4 border-b border-gray-200 pb-2 text-red-600">Not Allowed</h4>
                    <ul className="space-y-2">
                    <li className="flex items-center">
    ...
    <section className="py-16 bg-soft-white">
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <ScrollReveal delay={0.1}>
                ...
                <h3 className="text-xl font-bold text-primary mb-3">How far in advance should I book?</h3>
                <p className="text-gray-600">
                    We recommend booking at least 2-3 weeks in advance for weekday events and 4-6 weeks for weekend events. 
                    Popular dates can fill up quickly, especially during holiday seasons.
                </p>
                </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2}>
                <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-xl font-bold text-primary mb-3">Can I bring my own food and drinks?</h3>
                <p className="text-gray-600">
                    Yes! You&apos;re welcome to bring your own food or arrange catering. We also allow BYOB for alcoholic beverages.
                    Our barista will be available to serve coffee drinks from our menu at regular prices.
                </p>
                </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.3}>
                ...
                <p className="text-gray-600">
                    Yes, we require a 50% deposit to secure your booking. The remaining balance is due on the day of your event.
                    The deposit is fully refundable with 7 days&apos; notice of cancellation.
                </p>
                </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.4}>
                ...
                <p className="text-gray-600">
                    Absolutely! You&apos;re welcome to decorate the space to suit your event. We ask that you avoid anything that would damage
                    walls or surfaces (no nails or permanent adhesives). Please plan to arrive 30 minutes before your event to set up.
                </p>
                </div>
            </ScrollReveal>
            </div>
