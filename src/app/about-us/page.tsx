				...
				<div className="container mx-auto px-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
								...
								<img
									...
									onError={(e) => {
										...
										(e.target as HTMLImageElement).src =
											'https://via.placeholder.com/800x500?text=Coffee+Roasting';
									}}
								/>
							</div>
						</ScrollReveal>
						...
						<ScrollReveal delay={0.2}>
							...
							<p className="text-gray-700 mb-6 text-lg">
								Tre Stelle Coffee Co. was founded in late 2019, initially as a specialized
								micro-roasting company; since then, we have expanded into a full-service Coffee Shop
								& Roastery. Beyond serving exceptional coffee, our core mission is to create an
								inclusive coffee business that welcomes individuals from all backgrounds and walks
								of life.
							</p>
							<Link
								href="/products"
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-white rounded-2xl shadow-lg overflow-hidden mb-24">
						<ScrollReveal className="p-8 md:p-12">
							<h2 className="text-3xl md:text-4xl text-primary font-bold mb-6">Inspiration</h2>
							<p className="text-gray-700 mb-2 text-lg">
								The name &quot;Tre Stelle&quot; draws inspiration from a well-known cafe in Asmara,
								Eritrea; Eritrea has rich Italian cultural influences, and &quot;Tre Stelle&quot;
								translates to &quot;Three Stars&quot; in Italian.
							</p>
							<p className="text-gray-700 text-lg">
								In 2019, our founder, Jonathan traveled to Eritrea and visited this café, which
								inspired him to adopt the name for our business.
							</p>
						</ScrollReveal>
						...
						<ScrollReveal delay={0.2} className="h-full">
							<img
								...
								onError={(e) => {
									(e.target as HTMLImageElement).onerror = null;
									(e.target as HTMLImageElement).src =
										'https://via.placeholder.com/800x600?text=Original+Cafe+in+Eritrea';
								}}
							/>
						</ScrollReveal>
					</div>
						...
						<ScrollReveal className="order-2 md:order-1 h-full">
							<img
								...
								onError={(e) => {
									(e.target as HTMLImageElement).onerror = null;
									(e.target as HTMLImageElement).src =
										'https://via.placeholder.com/800x600?text=Coffee+Beans';
								}}
							/>
						</ScrollReveal>

						<ScrollReveal delay={0.2} className="p-8 md:p-12 order-1 md:order-2">
							<h2 className="text-3xl md:text-4xl text-primary font-bold mb-6">Sourcing</h2>
							<p className="text-gray-700 mb-4 text-lg">
								We work with green coffee suppliers who source beans from farms worldwide, ensuring
								we access only the highest quality coffee. This approach guarantees that farmers
								receive fair compensation for their hard work in producing exceptional beans.
							</p>
							<p className="text-gray-700 text-lg">
								This arrangement also creates greater transparency in the supply chain, establishing
								a direct line of communication between farmers, importers, and our roastery.
							</p>
						</ScrollReveal>
					</div>
				</div>
					...
					<div className="max-w-3xl mx-auto text-center">
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
							<ScrollReveal delay={0.1}>
								<div className="bg-primary/10 backdrop-blur-sm p-8 rounded-xl hover:bg-primary/20 transition-all duration-300 h-full">
									...
									<p className="text-center">
										We partner with green coffee suppliers who are passionate about quality and
										sustainability.
									</p>
								</div>
							</ScrollReveal>
							<ScrollReveal delay={0.2}>
								<div className="bg-primary/10 backdrop-blur-sm p-8 rounded-xl hover:bg-primary/20 transition-all duration-300 h-full">
									...
									<p className="text-center">
										We roast in small batches to ensure the perfect flavor profile for each bean.
									</p>
								</div>
							</ScrollReveal>
							<ScrollReveal delay={0.3}>
								<div className="bg-primary/10 backdrop-blur-sm p-8 rounded-xl hover:bg-primary/20 transition-all duration-300 h-full">
									...
									<p className="text-center">
										We prepare each cup with care, highlighting the unique qualities of our beans.
									</p>
								</div>
							</ScrollReveal>
						</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
						<ScrollReveal delay={0.1}>
							<div className="bg-white/10 p-8 rounded-xl backdrop-blur-sm h-full hover:bg-white/20 transition-all duration-300">
								...
								<p className="text-center">
									We strive to create a welcoming space for people from all backgrounds and walks of
									life to enjoy great coffee together.
								</p>
							</div>
						</ScrollReveal>
						...
						<ScrollReveal delay={0.2}>
							<div className="bg-white/10 p-8 rounded-xl backdrop-blur-sm h-full hover:bg-white/20 transition-all duration-300">
								...
								<p className="text-center">
									From sourcing to roasting to brewing, we are committed to excellence at every step
						...
						<ScrollReveal delay={0.3}>
							<div className="bg-white/10 p-8 rounded-xl backdrop-blur-sm h-full hover:bg-white/20 transition-all duration-300">
								...
								<p className="text-center">
									We believe in building relationships with our customers, suppliers, and the
				...
				<div className="container mx-auto px-4 text-center">
					<ScrollReveal>
						...
						<p className="text-xl mb-8 max-w-3xl mx-auto">
							Come experience our coffee, meet our team, and become part of the Tre Stelle
							community.
						</p>
						<div className="flex flex-col items-center gap-4">
							<a
								href="/find-us"
								className="px-8 py-3 bg-secondary text-dark-text font-semibold rounded-full uppercase tracking-wide text-sm transition-all duration-300 hover:bg-transparent hover:text-secondary border-2 border-secondary"
							>
							...
							<div className="flex items-center justify-center mt-4">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									className="h-6 w-6 text-tertiary mr-3"
									fill="none"
									viewBox="0 0 24 24"
									stroke="currentColor"
								>
