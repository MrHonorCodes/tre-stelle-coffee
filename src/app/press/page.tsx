            ...
            {featuredPress && (
                ...
                <ScrollReveal>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div className="relative pb-[56.25%] h-0 bg-black flex items-center justify-center cursor-pointer group" onClick={() => setShowVideo(true)}>
                        {!showVideo ? (
                            // Placeholder content
                            ...
                            />
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 text-white opacity-70 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M8 5v14l11-7z"/>
                            </svg>
                            <p className="text-white text-sm mt-2 opacity-70 group-hover:opacity-100 transition-opacity">Click to Play</p>
                            </div>
                        ) : (
