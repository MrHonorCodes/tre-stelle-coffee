...
export default function FindUs() {
	...
	return (
		<main className="min-h-screen bg-soft-white">
			...
			<section className="relative h-[60vh] overflow-hidden pt-16 flex items-center bg-primary">
				...
				<div className="container mx-auto px-4">
					<div className="max-w-3xl mx-auto text-center">
						<ScrollReveal>
							...
							<p className="text-xl text-gray-700 mb-12">
								<span className="font-bold">Mon-Fri:</span> 7am-5pm
								<br />
					...
					<div className="max-w-3xl mx-auto text-center">
						<ScrollReveal>
							...
							<p className="text-gray-700 mb-8">
								Follow us on social media to stay updated on our latest offerings, events, and
								promotions.
							</p>
							<div className="flex justify-center space-x-6">
								<a
									...
									target="_blank"
									rel="noopener noreferrer"
									className="h-14 w-14 rounded-full bg-secondary text-primary flex items-center justify-center border-2 border-primary hover:bg-primary hover:text-secondary transition-all duration-300"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
										className="h-6 w-6"
