      ...
      <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div key={index} className="bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="space-y-2">
                {section.links.map((link, linkIndex) => (
                  <li key={linkIndex} className="hover:translate-x-1 transition-transform duration-200">
                    <Link 
                      href={link.path}
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-gray-600 mt-2">
            If you can&apos;t find what you&apos;re looking for, please <Link href="/contact" className="text-secondary hover:underline">contact us</Link>.
          </p>
        </div>
      </div>
    </div>
