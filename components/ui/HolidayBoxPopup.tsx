			...
			<div className="relative bg-soft-white rounded-2xl shadow-2xl max-w-2xl w-full mx-4 overflow-hidden animate-in fade-in-0 zoom-in-95 duration-300">
				...
				<div className="grid md:grid-cols-2 gap-0">
					...
					<div className="p-6 md:p-8 flex flex-col justify-center">
						<div className="hidden md:inline-block bg-red-100 text-red-700 text-xs font-bold px-3 py-1 rounded-full mb-3 self-start">
							🎄 LIMITED TIME OFFER
						</div>
						
						{/* Title and Price - Side by side on very small screens */}
						<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
							<h2 className="text-2xl md:text-3xl font-bold text-primary sm:mb-0 mb-2">
								Holiday Box Special
							</h2>
							
							{/* Price for very small screens - next to title */}
							<div className="hidden sm:flex items-baseline">
								<span className="text-2xl font-bold text-primary">$60</span>
								<span className="text-gray-500 ml-1.5 line-through text-sm">$85</span>
							</div>
						</div>
						
						<p className="text-gray-700 mb-4 leading-relaxed text-sm md:text-base sm:hidden">
						...
						{/* Price for larger screens - below list */}
						<div className="flex items-baseline mb-6 sm:hidden">
							<span className="text-3xl md:text-4xl font-bold text-primary">$60</span>
							<span className="text-gray-500 ml-2 line-through text-base md:text-lg">$85</span>
							<span className="text-green-600 ml-2 font-semibold text-sm md:text-base">Save $25!</span>
						</div>
